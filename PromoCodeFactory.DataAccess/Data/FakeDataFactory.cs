...
namespace PromoCodeFactory.DataAccess.Data
{
    public static class FakeDataFactory
    {
            ...
            get
            {
                ...
                var customers = new List<Customer>()
                {
                    new Customer()
                    {
                        ...
                        {
                            PromoCodes.FirstOrDefault(x => x.Code == "Промо1")
                        }
                    }
                };
        ...
        public static IEnumerable<PromoCode> PromoCodes => new List<PromoCode>()
        {
            new PromoCode()
            {
                Id = Guid.Parse("ef7f299f-92d7-459f-896e-078ed53ef01c"),
                Code = "Промо1",
                ServiceInfo = "Сервис1",
                BeginDate = System.DateTime.Parse("01/02/2025"),
                EndDate =   System.DateTime.Parse("02/02/2025"),
